...
El trabajo se organizó en dos frentes que avanzaron en paralelo. Las decisiones que condicionaban la entrega las tomamos en conjunto: el framework, el router, la estrategia de persistencia, el tercer framework de la comparación y el criterio de ordenamiento del listado.

Valeria Gómez se encargó de revisar y validar el informe, de contrastar que lo escrito coincidiera con lo que la aplicación hace, y de probar la aplicación en el emulador frente a los criterios de aceptación definidos en BRIEF.md. Otton Lucena llevó la construcción del proyecto y la ejecución de las fases de desarrollo.
